...
def main():
    parser = argparse.ArgumentParser(description="生成确认图批次清单，固定 A-01 单个提交位且失败占位。")
    ...
    parser.add_argument("--entry", action="append", required=True, help="提交位 JSON，必须正好提供 A-01 一个")
